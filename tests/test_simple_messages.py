...
from love_bot.handlers.simple_messages import (
    handle_message, send_cuteness_immediately, show_all_dreams,
...
@patch(
    'love_bot.handlers.simple_messages.show_content', new_callable=AsyncMock,
)
...
@pytest.mark.asyncio
@patch(
    'love_bot.handlers.simple_messages.write_content', new_callable=AsyncMock,
)
async def test_handle_message_me(mock_write, message):
