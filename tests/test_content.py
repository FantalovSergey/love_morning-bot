...
@patch(
    "love_bot.content.get_content_from_file",
    return_value=[],
)
@patch(
...
@pytest.mark.asyncio
async def test_send_love_message_empty_file(
    mock_send,
    mock_get_content,
):
...
@patch(
    "love_bot.content.choice",
    return_value="Доброе утро ❤️",
)
@patch(
    "love_bot.content.get_content_from_file",
    return_value=["Доброе утро ❤️"],
...
@pytest.mark.asyncio
async def test_show_content_empty(
    mock_send,
    message,
):
...
@pytest.mark.asyncio
async def test_show_content_single_chunk(
    mock_send,
    message,
):
    mock_send.return_value = "msg"
...
@pytest.mark.asyncio
async def test_show_content_multiple_chunks(
    mock_send,
    message,
):
...
@pytest.mark.asyncio
async def test_show_content_forwards_Arina_request(
    mock_send,
    message,
):
